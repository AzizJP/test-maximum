...
- [Ссылка на хостинг](https://test-maximum-dun.vercel.app/)

### Команды для локального запуска приложения

- Установка необходимых пакетов - `npm i`
- Запуск приложения(приложение будет доступно на localhost:3000) - `npm run dev`
...
- Функционал реализован на Next.js
